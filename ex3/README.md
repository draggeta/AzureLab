...
1. Pas alle `UDRs` aan zodat **ALLEEN** verkeer richting de bovenstaande subnetten via de `SD-WAN NVA` appliance loopt. Overige destinations moeten via de `AZF` blijven lopen.
